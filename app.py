...
app.register_functions(user_blueprint)
app.register_functions(maincompany_blueprint)
app.register_functions(roles_blueprint)
app.register_functions(customer_blueprint )

app.register_functions(employee_blueprint)
app.register_functions(salesorders_blueprint)
app.register_functions(salesorderdetails_blueprint)
app.register_functions(productcategory_blueprint)
app.register_functions(productsubcategory_blueprint)
app.register_functions(paymentsales_blueprint)
app.register_functions(purchasecategory_blueprint)
app.register_functions(purchasesubcategory_blueprint)
app.register_functions(supplier_blueprint)
app.register_functions(purchaseorder_blueprint)
app.register_functions(purchaseorderdetail_blueprint)
app.register_functions(salarypayroll_blueprint)
app.register_functions(officepurchaseitemlist_blueprint)
